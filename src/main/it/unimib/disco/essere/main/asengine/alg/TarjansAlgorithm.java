...
public class TarjansAlgorithm
{
    ...
    public TarjansAlgorithm(Graph graph, List<Vertex> vertices, String vertexType, String depLabel)
    {
        this.graph = graph;
    ...
    {
        SuperCycleShapeClassifier shapeClassifier = new SuperCycleShapeClassifier(comps, edges, order, size, vertexType);
